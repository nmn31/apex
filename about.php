...
<section class="content-section" id="team">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="images/member3.webp" alt="Team Member">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="images/member2.jpeg" alt="Team Member">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="images/member1.webp" alt="Team Member">
                    <div class="card-body">
